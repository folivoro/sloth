...
final class Layotter extends \Singleton
{
     ...
     * @return array
     */
    final public static function allowed_row_layouts($row_layouts)
    {
     ...
     * @return string
     */
    final public static function default_row_layout($row_layout)
    {
     ...
     */
    final public static function disable_for_post_type($post_type)
    {
     ...
     */
    final public static function enable_for_post_type($post_type)
    {
     ...
     * @return string
     */
    final public static function enabled_post_types($post_types)
    {
        ...
        foreach ($all_types as $post_type => $data) {
            if (! in_array(
                $post_type,
                self::$disabled_post_types
            )) { #if the post_type isn't in $disabled_post_types
     ...
     */
    final public static function set_layouts_for_post_type($post_type, array $layouts)
    {
     ...
     * @param array $layouts  The layouts that will be enabled in Layotter's convention (e.g. ['1/2 1/2', '1/3 1/3 1/3']
     */
    final public static function set_layouts_for_template($template, array $layouts)
    {
